    ...
    <div className="container mx-auto px-4 py-20 grid md:grid-cols-2 gap-8 items-center">
      ...
      >
        ...
        <div className="flex flex-wrap gap-4">
          ...
          <button className="px-6 py-2 bg-transparent border border-[#1A936F] text-[#1A936F] dark:border-[#88D498] dark:text-[#88D498] rounded-full hover:bg-[#1A936F] hover:text-white dark:hover:bg-[#88D498] dark:hover:text-[#114B5F] transition-colors">
            Download CV
          </button>
        </div>
          ...
          <div className="relative rounded-lg overflow-hidden border border-[#1A936F]/10 dark:border-[#88D498]/30 shadow-xl bg-white/50 dark:bg-[#114B5F]/50 transition-colors duration-300">
            ...
            <div className="relative p-8 space-y-6">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 bg-[#1A936F]/10 dark:bg-[#1A936F]/20 rounded-lg flex items-center justify-center">
                  <span className="text-2xl font-bold text-[#1A936F] dark:text-[#88D498]">7+</span>
                </div>
                <div>
              ...
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 bg-[#1A936F]/10 dark:bg-[#88D498]/20 rounded-lg flex items-center justify-center">
                  <span className="text-2xl font-bold text-[#1A936F] dark:text-[#88D498]">3</span>
                </div>
                <div>
                  <h4 className="text-lg font-medium">Internships</h4>
              ...
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 bg-[#1A936F]/10 dark:bg-[#88D498]/20 rounded-lg flex items-center justify-center">
                  <span className="text-2xl font-bold text-[#1A936F] dark:text-[#88D498]">8.74</span>
                </div>
                <div>
                  <h4 className="text-lg font-medium">CGPA</h4>
